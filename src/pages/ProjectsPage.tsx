...
import { ExternalLink, Github, Zap, Calendar, CheckCircle2 } from 'lucide-react'
...
const projects = [
  {
    ...
    accentColor: '#00d9ff',
    tech: ['Next.js 14', 'TypeScript', 'Tailwind CSS', 'Convex', 'Framer Motion', 'OpenAI TTS'],
    features: [
  ...
  },
  {
    ...
    accentColor: '#b300ff',
    tech: ['Next.js 14', 'TypeScript', 'Tailwind CSS', 'Liveblocks', 'WebSocket', 'App Router'],
    features: [
      'Real-time multi-user editing with WebSocket-based synchronization',
      'Efficient conflict resolution for concurrent edit management',
      'Next.js 14 App Router for optimized TTI (Time-to-Interactive)',
      'Live cursor tracking with real-time presence indicators',
      'Enterprise-grade collaborative reliability and security',
      'Optimized server components for enhanced performance',
    ],
  ...
  },
  {
    ...
    accentColor: '#0080ff',
    tech: ['Next.js 14', 'TypeScript', 'Appwrite', 'Dwolla', 'Plaid', 'JWT', 'Prisma'],
    features: [
      ...
      <div className="p-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
          <div>
            ...
            <h2 className="font-sans font-bold text-3xl text-white">{project.title}</h2>
            <p className="font-mono text-sm mt-1" style={{ color: project.accentColor }}>
              {project.tagline}
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              style={{ background: `linear-gradient(135deg, ${project.accentColor}, #0080ff)` }}
            >
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div>
            <p className="font-mono text-xs text-text-muted tracking-widest mb-4">KEY FEATURES</p>
            <ul className="space-y-2.5">
              {project.features.map((f, i) => (
                <li key={i} className="flex items-start gap-2.5">
                  <CheckCircle2 size={14} className="mt-0.5 flex-shrink-0" style={{ color: project.accentColor }} />
          ...
          <div>
            <div className="glass rounded-xl border border-white/5 p-5 mb-4">
              <div className="flex items-start gap-2 mb-3">
                <Zap size={14} className="mt-0.5" style={{ color: project.accentColor }} />
                <p className="font-mono text-xs text-text-muted tracking-widest">IMPACT</p>
              </div>
              <p className="text-white text-sm leading-relaxed">{project.impact}</p>
            </div>

            <div>
              <p className="font-mono text-xs text-text-muted tracking-widest mb-3">TECH STACK</p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-text-secondary mt-4 max-w-xl mx-auto text-lg">
              Production-grade applications built with modern tooling, real-world APIs, and obsessive attention to detail.
            </p>
          </motion.div>
